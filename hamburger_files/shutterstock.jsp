...
"undefined"==typeof usi_company&&(window.usi_company={rulesets:{testing:function(e){return!e.testing||usi_cookies.get("usi_enable")},device:function(e){return!e.device||usi_commons.device===e.device},required_cookies:function(e){return!e.required_cookies||usi_cookies.value_exists.apply(null,e.required_cookies)},suppress_cookies:function(e){if(!e.suppress_cookies)return!0;for(var r=0;r<e.suppress_cookies.length;r++)if(usi_cookies.value_exists(e.suppress_cookies[r]))return!1;return!0},required_elements:function(e){if(!e.required_elements)return!0;try{for(var r=0;r<e.required_elements.length;r++)if(!document.querySelector(e.required_elements[r]))return!1;return!0}catch(i){return!1}},min_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.min_subtotal||r>e.min_subtotal},max_subtotal:function(e){var r=usi_cookies.get("usi_subtotal")?Number(usi_cookies.get("usi_subtotal").replace(/[^0-9.]/g,"")):0;return!e.max_subtotal||r<e.max_subtotal},date_ranges:function(e){return e.date_ranges&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.date_ranges||e.date_ranges.some(function(e){return usi_date.is_between(e[0],e[1])})},is_after:function(e){return e.is_after&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_after||usi_date.is_after(e.is_after)},is_before:function(e){return e.is_before&&"undefined"==typeof usi_date?usi_commons.log("usi_date is required"):!e.is_before||usi_date.is_before(e.is_before)},page_visits:function(e){return!e.page_visits||Number(usi_cookies.get("usi_page_visits"))>=e.page_visits},countries:function(e){return e.countries&&!usi_app.country?usi_commons.log("usi_app.country is required"):!e.countries||-1!==e.countries.indexOf(usi_app.country)},traffic_source:function(e){return void 0===e.traffic_source||""===usi_cookies.get("usi_traffic_source")&&"direct"===e.traffic_source.toLowerCase()||!!usi_cookies.get("usi_traffic_source").match(e.traffic_source)},pages:function(e){return void 0===e.pages||e.pages.some(function(e){return -1!==location.href.indexOf(e)})},suppressed_pages:function(e){return void 0===e.suppressed_pages||!e.suppressed_pages.some(function(e){return -1!==location.href.indexOf(e)})},logged_in:function(e){return void 0===e.logged_in||(e.logged_in?"loggedin"===usi_cookies.get("usi_visitor"):e.logged_in?void 0:"loggedin"!==usi_cookies.get("usi_visitor"))},logged_out:function(e){return void 0===e.logged_out||(e.logged_out?"loggedin"!==usi_cookies.get("usi_visitor"):e.logged_out?void 0:"loggedin"===usi_cookies.get("usi_visitor"))},return_visitor:function(e){return void 0===e.return_visitor||((void 0===usi_app.is_return_visitor&&usi_commons.log_error("usi_app.is_return_visitor is required"),e.return_visitor)?usi_app.is_return_visitor:e.return_visitor?void 0:!usi_app.is_return_visitor)},new_visitor:function(e){return void 0===e.new_visitor||((void 0===usi_app.is_return_visitor&&usi_commons.log_error("usi_app.is_return_visitor is required"),e.new_visitor)?!usi_app.is_return_visitor:e.new_visitor?void 0:usi_app.is_return_visitor)},return_customer:function(e){return void 0===e.return_customer||(e.return_customer?usi_cookies.get("usi_customer_purchased"):e.return_customer?void 0:!usi_cookies.get("usi_customer_purchased"))},new_customer:function(e){return void 0===e.new_customer||(e.new_customer?!usi_cookies.get("usi_customer_purchased"):e.new_customer?void 0:usi_cookies.get("usi_customer_purchased"))}},test_load:function(e,r){return!1},before_load:function(e){usi_commons.log("Loading: "+(e._name?e._name+", ":e.name?e.name+", ":"")+(e.siteID?e.siteID:"")),"string"==typeof e.before_load&&"function"==typeof usi_app[e.before_load]&&usi_app[e.before_load](e)},load_campaigns:function(e,r){try{if(!e||!e.campaigns)return;function i(e,r){var i=0;!function t(){if(!(i>=e.length)){var s=e[i++];r(s,function(e){e||t()})}}()}function t(e,r,i){if(!e)return"";var t=e.match(/^{{\s*usi_app\.([\w.]+)\s*}}$/);if(t){var s=t[1].split(".");let o=usi_app;for(let n of s){if(null==o||"object"!=typeof o)return e;o=o[n]}return"function"==typeof o?o(i||r):o}return e.replace(/{{\s*usi_commons\.device\s*}}/,usi_commons.device).replace(/{{\s*usi_app\.([\w.]+)\s*}}/g,function(e,r){if(!r)return e;for(var t=r.split("."),s=usi_app,o=0;o<t.length;o++){if(null==s||"object"!=typeof s)return e;s=s[t[o]]}return null==s?e:"function"==typeof s?s(i):s})}function s(e,r){var i=Object.assign(e);for(var s in i)i.hasOwnProperty(s)&&"string"==typeof i[s]&&i[s].match(/{{\s*usi_app\.(\w+)\s*}}/)&&(i[s]=t(i[s],i,r));return i}function o(e,r){try{var i,o,n,u=[];for(var a in usi_company.rulesets)!usi_company.custom_rulesets[a]&&usi_company.rulesets.hasOwnProperty(a)&&((0,usi_company.rulesets[a])(e)||u.push(a));for(var c in usi_company.custom_rulesets)usi_company.custom_rulesets.hasOwnProperty(c)&&((0,usi_company.custom_rulesets[c])(e)||u.push(c));if(e._missing=u,u.length>0)return r(!1);var f=[];if(e.list){if(!usi_app.company_id)return usi_commons.log_error("usi_app.company_id is required");if(!e.list.ids)return usi_commons.log_error("campaign.list.ids is required");if(!e.list.label)return usi_commons.log_error("campaign.list.label is required");f.push(function(r){var i=s(e.list,e);usi_company.lookup_callback=function(t){try{e.list._found=t,i.type=i.type||"suppress";var s=0===t&&"suppress"===i.type||1===t&&"enable"===i.type;r(s)}catch(o){usi_commons.report_error(o)}};var o=usi_commons.domain+"/utility/lookup_suppressions.jsp?companyID="+usi_app.company_id+"&product="+(Array.isArray(i.ids)?i.ids.join(","):t(i.ids,e))+"&label="+i.label+"&match="+(i.match||"any")+"&callback=usi_company.lookup_callback";usi_commons.load_script(o)})}if(e.lift){if("undefined"==typeof usi_split_test)return usi_commons.log_error("usi_split_test is required");if(!e.lift.id)return usi_commons.log_error("campaign.lift.id is required");f.push(function(r){usi_split_test.instantiate_callback(e.lift.id,function(i){if(0===i)return r(!1);e.lift._group=i,r(!0)})})}"object"==typeof e.split&&f.push(function(r){var i,t=Object.keys(e.split),s=usi_commons.gup("usi_force_group");if(s)i=s;else if(e._group)i=e._group;else if(e.lift&&"boolean"==typeof e.lift.split&&e.lift.split&&e.lift._group)i=e.lift._group;else{for(var o=0,n={},u=0;u<t.length;u++){var a=t[u],c=e.split[a].percent;n[a]="number"==typeof c&&c>0?c:1,o+=n[a]}for(var f=Math.random()*o,p=0,l=0;l<t.length;l++){var d=t[l];if(p+=n[d],f<p){i=d;break}}i||(i=t[0])}var g=e.split[i];for(var m in g)g.hasOwnProperty(m)&&(e[m]=g[m]);e._group=i,r(!0)}),e.recommendations&&f.push(function(r){var i=s(e.recommendations,e);return i.pid?i.siteID?void(i.callback=function(){var i=e.recommendations.name?e.recommendations.name.replace("usi_app.",""):"product_rec",t=usi_commons.gup("usi_test")||(usi_app[i]&&usi_app[i].data&&usi_app[i].data.length?usi_app[i].data.length:0)>=(e.recommendations.min_rows||e.recommendations.rows||3);e.recommendations.filter_callback&&"function"==typeof usi_app[e.recommendations.filter_callback]&&usi_app[e.recommendations.filter_callback](e),r(t)},usi_commons.load_products(i)):usi_commons.log_error("recommendations.siteID is required"):usi_commons.log_error("recommendations.pid is required")}),i=f,o=function(i){r(i,e)},n=0,function e(r){return r?n>=i.length?o(!0):void i[n++](e):o(!1)}(!0)}catch(p){usi_commons.report_error(p),r(!1)}}usi_company.custom_rulesets=r||[],e.campaigns.usi_load&&i(e.campaigns.usi_load,function(e,r){e._type="usi_load",o(e,function(e,i){i&&(i._active=e),e&&i&&i.siteID&&i.hash?(usi_company.before_load(i),usi_commons.load(i.hash,i.siteID,i.key?t(i.key,i):"",function(){void 0!==window["usi_"+i.siteID]&&(window["usi_"+i.siteID].company_json=s(i)),r(usi_company.test_load(e,i))})):r(e)})}),e.campaigns.view&&i(e.campaigns.view,function(e,r){"undefined"==typeof usi_force&&-1==location.href.indexOf("usi_force")&&(e.suppress_cookies=e.suppress_cookies||[],-1===e.suppress_cookies.indexOf("usi_sale")&&(e.suppress_cookies=e.suppress_cookies.concat("usi_sale","usi_launched","usi_launched"+e.siteID))),e._type="view",o(e,function(e,i){i&&i.siteID&&i.hash&&(i._active=e,e&&(usi_company.before_load(i),usi_commons.load_view(i.hash,i.siteID,i.key?t(i.key,i):"",function(){"undefined"!=typeof usi_js&&(usi_js.company_json=s(i))}))),r(e)})}),e.campaigns.anon&&i(e.campaigns.anon,function(e,r){e._type="anon",o(e,function(e,i){i&&i.siteID&&(i._active=e,usi_app.anon_data=s(i),e&&(usi_company.before_load(i),usi_user_id.activate(i.siteID))),r(e)})}),e.campaigns.precapture&&i(e.campaigns.precapture,function(e,r){e._type="precapture",o(e,function(e,i){i&&i.siteID&&i.hash&&(i._active=e,usi_app.precapture_data=s(i),e&&(usi_company.before_load(i),usi_commons.load_precapture(i.hash,i.siteID))),r(e)})})}catch(n){usi_commons.report_error(n)}}});
